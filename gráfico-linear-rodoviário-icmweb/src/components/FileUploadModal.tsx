      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 max-w-xl w-full p-6 relative animate-in fade-in zoom-in-95 duration-150">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center space-y-3">
            <div className="w-12 h-12 rounded-full bg-sky-50 text-sky-600 flex items-center justify-center shadow-inner">
        ...
        {isProcessing && (
          <div className="mt-4 p-4 bg-sky-50 border border-sky-200 rounded-xl flex items-center justify-center space-x-3 text-sky-800">
            <RefreshCcw className="w-5 h-5 animate-spin text-sky-600" />
        ...
        <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center space-x-1.5 bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-semibold px-3.5 py-2 rounded-xl transition-colors"
          >
