        ...
        <div className="flex flex-wrap lg:flex-nowrap items-center justify-between min-h-[64px] py-2 gap-3">
          ...
          <div className="flex items-center space-x-3 shrink-0">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="bg-purple-500/20 text-purple-300 text-xs px-2 py-0.5 rounded-full font-mono border border-purple-400/30 whitespace-nowrap">
                  ICMWeb v2.5
                </span>
              </div>
          ...
          <div className="flex items-center bg-slate-800 p-1 rounded-lg border border-slate-700/60 overflow-x-auto max-w-full scrollbar-none gap-1 shrink-0">
            <button
              ...
              className={`flex items-center space-x-1.5 px-3 py-1.5 rounded-md text-xs font-semibold transition-all whitespace-nowrap shrink-0 ${
                activeTab === 'report'
                  ? 'bg-[#4B0B56] text-white shadow-sm'
          ...
          <div className="flex items-center space-x-2 shrink-0">
            <button
              ...
              className="flex items-center space-x-1.5 bg-[#4B0B56] hover:bg-[#380842] text-white text-xs font-medium px-3 py-2 rounded-lg transition-colors shadow-sm disabled:opacity-50 cursor-pointer"
