...
import { Plus, Trash2, Edit3, Eye, FileDown, FileImage, Layers, MapPin, Building2, Check, X } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center space-x-2 bg-[#4B0B56] hover:bg-[#380842] text-white text-xs font-semibold px-4 py-2.5 rounded-xl transition-all shadow-md cursor-pointer self-start md:self-auto"
        >
      ...
      {/* Form Add / Edit */}
      {isAdding && (
        <div className="bg-slate-900/90 border border-purple-500/40 rounded-2xl p-5 shadow-2xl space-y-4 animate-in fade-in slide-in-from-top-2">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <h3 className="font-semibold text-sm text-purple-300 flex items-center space-x-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-xs">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-700 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-purple-500 font-mono"
              />
            </div>
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end space-x-2">
                          <button
                            ...
                            className="bg-purple-600/20 hover:bg-purple-600/40 text-purple-300 border border-purple-500/30 px-3 py-1.5 rounded-lg text-[11px] font-semibold transition-all flex items-center space-x-1 cursor-pointer"
                          ...
                          <button
                            onClick={() => {
                              onViewDiagramForContract(c);
                              setTimeout(async () => {
                                const btn = document.getElementById('btn-export-png-trigger');
                                if (btn) {
                                  btn.click();
                                }
                              }, 400);
                            ...
                            className="bg-purple-600/20 hover:bg-purple-600/40 text-purple-300 border border-purple-500/30 px-3 py-1.5 rounded-lg text-[11px] font-semibold transition-all flex items-center space-x-1 cursor-pointer"
                            title="Exportar Imagem PNG deste Contrato"
                          >
