      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-slate-800 rounded-2xl p-5 border border-slate-700/80 shadow-lg flex flex-wrap items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center space-x-2 bg-slate-700 hover:bg-slate-600 text-slate-200 text-xs font-semibold px-3.5 py-2 rounded-xl transition-colors border border-slate-600 cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 bg-slate-800/80 p-4 rounded-xl border border-slate-700">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-900 text-white text-xs pl-9 pr-3 py-2 rounded-lg border border-slate-700 focus:outline-none focus:border-purple-500"
            />
          </div>
          ...
          <div>
            <select
              ...
              className="w-full bg-slate-900 text-white text-xs px-3 py-2 rounded-lg border border-slate-700 focus:outline-none focus:border-purple-500"
            >
